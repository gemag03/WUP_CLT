...
Take the standard deviation and put it in the data that is from the central limit. The standard deviation shrinks as the number gets higher.Example 4 is divided by 2, example 9 is divided by 3, example 16 is divided by 4, and so on.
