...
Take the standard deviation and put it in the data that is from the central limit. The standard deviation shrinks as the number gets higher.Example 4 is divided by 2, example 9 is divided by 3, example 16 is divided by 4, and so on. The standard deviation is n=9. The mean will always stay the same and the standard deviation will always shrink. The expected value is 41. We expected 14 and got 13.6.`r sd (my1000$k3)`
...
The standard deviation is now a quarter of what it was before which now it is 10.3. We expected 10 and got 10.3. `r sd (my1000$k4)`.
...
We expected 8 and we got 8.2. `r sd (my1000$k5)`.
